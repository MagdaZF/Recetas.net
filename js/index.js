...
}else if (deseaRegistrarseLower=="n"){
	alert("Disfrute la página")
}else {
	/* while (deseaRegistrarseLower != "s" || deseaRegistrarseLower != "n"){
		alert("La respuesta ingresada es incorrecta, ingrese una respuesta correcta (s/n)")
		deseaRegistrarse = prompt("Desea registrarse en nuestra página?(s/n): ")
		deseaRegistrarseLower = deseaRegistrarse.toLowerCase()
	}   */
}
